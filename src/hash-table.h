...
typedef /*@abstract@*/ struct _HashTable HashTable;

/**
 * Structure used to iterate over a hash table.
 */

typedef /*@abstract@*/ struct _HashTableIterator HashTableIterator;

/**
 * Internal structure representing an entry in a hash table.
 */

typedef /*@abstract@*/ struct _HashTableEntry HashTableEntry;
...
struct _HashTableIterator {
	...
	/*@null@*/ /*@dependent@*/ HashTableEntry *next_entry;
...
typedef unsigned int (*HashTableHashFunc)(/*@null@*/ HashTableKey value);
...
typedef int (*HashTableEqualFunc)(
		/*@null@*/ HashTableKey value1, 
		/*@null@*/ HashTableKey value2);
...
typedef void (*HashTableKeyFreeFunc)(
		/*@null@*/ /*@only@*/ HashTableKey value);
...
typedef void (*HashTableValueFreeFunc)(
		/*@null@*/ /*@only@*/ HashTableValue value);
...
void hash_table_iterate(
		/*@notnull@*/ /*@dependent@*/ HashTable *hash_table, 
		/*@notnull@*/ /*@temp@*/ HashTableIterator *iter);
 ...
 *
 * Note: Also note that @ref HashTablePair fields are pointers to storage. When 
 * 		 table is configured to free keys and values upon removal of an entry 
 * 		 then it might be the case that the pointers returned will be dangling.
 *
 * @param iterator            The hash table iterator.
